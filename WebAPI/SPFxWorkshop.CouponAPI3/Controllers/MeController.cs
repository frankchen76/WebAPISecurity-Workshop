...
using SPFxWorkshop.CouponAPI3.Model;
...
namespace SPFxWorkshop.CouponAPI3.Controllers
{
    ...
    public class MeController : Controller
    {
        ...
        private async Task<UserInfo> CallGraphApiOnBehalfOfUser()
        {
        ...
        private async Task<UserInfo> CallGraphApiOnBehalfOfUser(string accessToken)
        {
